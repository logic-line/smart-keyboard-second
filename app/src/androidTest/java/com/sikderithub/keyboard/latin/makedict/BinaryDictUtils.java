...
package com.sikderithub.keyboard.latin.makedict;
...
public class BinaryDictUtils {
    ...
    public static final FormatOptions STATIC_OPTIONS =
            new FormatOptions(FormatSpec.VERSION202);
    public static final FormatOptions DYNAMIC_OPTIONS_WITHOUT_TIMESTAMP =
            new FormatOptions(FormatSpec.VERSION4, false /* hasTimestamp */);
    public static final FormatOptions DYNAMIC_OPTIONS_WITH_TIMESTAMP =
            new FormatOptions(FormatSpec.VERSION4, true /* hasTimestamp */);
