...
public final class SecondSetupWizardActivity extends Activity implements View.OnClickListener {
    private static final int NOTIFICATION_PERMISSION_REQUEST_CODE = 1001;
    static final String TAG = SecondSetupWizardActivity.class.getSimpleName();
    ...
    private static final class SettingsPoolingHandler
            extends LeakGuardHandlerWrapper<SecondSetupWizardActivity> {
        private static final int MSG_POLLING_IME_SETTINGS = 0;
        private static final long IME_SETTINGS_POLLING_INTERVAL = 200;

        private final InputMethodManager mImmInHandler;

        public SettingsPoolingHandler(@Nonnull final SecondSetupWizardActivity ownerInstance,
        ...
        public void handleMessage(final Message msg) {
            final SecondSetupWizardActivity setupWizardActivity = getOwnerInstance();
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mSetupWizard = findViewById(R.id.second_setup_wizard);
        ...
        mWelcomeScreen = findViewById(R.id.second_setup_welcome_screen);
        final TextView welcomeTitle = (TextView)findViewById(R.id.app_title);
        ...
        final SetupStep step2 = new SetupStep(STEP_2, applicationName,
                R.string.setup_step2_instruction_bn,
        ...
        data.put("Activity", SecondSetupWizardActivity.class.getSimpleName());
    ...
    void hideWelcomeVideoAndShowWelcomeImage() {
        Log.d(TAG, "hideWelcomeVideoAndShowWelcomeImage: ");
    ...
    private void showAndStartWelcomeVideo() {
        Log.d(TAG, "showAndStartWelcomeVideo: ");
    ...
    private void hideAndStopWelcomeVideo() {
        Log.d(TAG, "hideAndStopWelcomeVideo: ");
