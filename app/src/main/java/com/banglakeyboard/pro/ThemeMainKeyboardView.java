 ...
 */
public class ThemeMainKeyboardView extends ThemeKeyboardView implements
    ...
    private static final String TAG = ThemeMainKeyboardView.class.getSimpleName();
    ...
    public ThemeMainKeyboardView(final Context context, final AttributeSet attrs) {
        this(context, attrs, R.attr.mainKeyboardViewStyle);

    }

    public ThemeMainKeyboardView(final Context context, final AttributeSet attrs, final int defStyle) {
