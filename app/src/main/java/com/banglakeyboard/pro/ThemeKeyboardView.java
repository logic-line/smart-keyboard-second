 ...
 */
public class ThemeKeyboardView extends View {
    // XML attributes
    ...
    public ThemeKeyboardView(final Context context, final AttributeSet attrs) {
        this(context, attrs, R.attr.keyboardViewStyle);
    }

    public ThemeKeyboardView(final Context context, final AttributeSet attrs, final int defStyle) {
